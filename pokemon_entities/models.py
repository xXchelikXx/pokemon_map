...
class Pokemon(models.Model):
    ...
    previous_evolution = models.ForeignKey("self", on_delete=models.SET_NULL, blank=True, null=True, verbose_name="предыдущая эволюция", related_name="next_evolutions")
