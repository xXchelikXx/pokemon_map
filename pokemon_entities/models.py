...
class Pokemon(models.Model):
	title = models.CharField(
		max_length=200, blank=True, verbose_name="имя покемона"
	)
	title_en = models.CharField(
		max_length=200, blank=True, verbose_name="имя покемона(англ)"
	)
	title_jp = models.CharField(
		max_length=200, blank=True, verbose_name="имя покемона(яп)"
	)
...
class PokemonEntity(models.Model):
	...
	appeared_at = models.DateTimeField(
		verbose_name="время появленя", blank=True, null=True
	)
	disappeared_at = models.DateTimeField(
		verbose_name="время исчезновения", blank=True, null=True
	)
